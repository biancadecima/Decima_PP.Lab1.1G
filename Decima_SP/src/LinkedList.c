 ...
 * \param this LinkedList* Puntero a la lista
 * \param (*pFunc)(void *element) Funcion que evalua el filtrado
 * \return LinkedList* nueva lista cargada con los elementos filtrados
 */
...
/** \brief asigna items a la lista utilizando la funcion criterio recibida como parametro
 * \param this LinkedList* Puntero a la lista
 * \param (*pFunc)(void *element) Funcion que asigna valores
 * \return LinkedList*  lista cargada con los elementos mapeados
 */
